 ...
 */
package org.modelexecution.fuml.extlib.papyrus;
...
public class PapyrusModelILExecutor {
	...
	public PapyrusModelILExecutor(String modelpath) {
		this.modelPath = modelpath;
		integrationLayer = new IntegrationLayerImpl();
	...
	public ExecutionContext getExecutionContext() {
		return integrationLayer.getExecutionContext();
	}
