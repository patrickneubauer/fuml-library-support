...
/**
 * This class tests if the {@link PapyrusModelILExecutor} is able to execute a large Papyrus file
 * containing a more realistic scenario.
 * 
 ...
 *
 */
public class PetstoreILExecutionTest implements ExecutionEventListener {
