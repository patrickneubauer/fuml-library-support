...
public class ActionHelperTest {
	...
	public void getClassNamespaceAndNameOfCreateObjectActionNoClassNameTest() {
		...
		try {
			...
			assertTrue(e.getMessage().contains("Error occured while trying to obtain the Class name from fUML.Syntax.Actions.IntermediateActions.CreateObjectAction"));
			thrown = true;
		}
	...
	@Test
	public void getClassNamespaceAndNameOfCallOperationActionNoClassNameTest() {
		boolean thrown = false;
		...
		try {
			...
			assertTrue(e.getMessage().contains("Error occured while trying to obtain the Class name from fUML.Syntax.Actions.BasicActions.CallOperationAction"));
			thrown = true;
		}
